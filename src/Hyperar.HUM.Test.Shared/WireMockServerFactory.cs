namespace Hyperar.HUM.Test.Shared
{
    ...
    public static class WireMockServerFactory
    {
        ...
        public static int StartServerAndGetPort()
        {
            lock (serverLock)
            {
                if (server == null)
                {
                    ...
                    ConfigureCheckTokenRequests();
                    ConfigureGetAccessTokenRequests();
                    ConfigureInvalidateAccessTokenRequests();
                    ConfigureGetRequestTokenRequests();
                }
        ...
        private static void ConfigureCheckTokenRequests()
        {
        ...
        private static void ConfigureGetAccessTokenRequests()
        {
            ArgumentNullException.ThrowIfNull(server);
        ...
        private static void ConfigureGetRequestTokenRequests()
        {
            ArgumentNullException.ThrowIfNull(server);
        ...
        private static void ConfigureInvalidateAccessTokenRequests()
        {
            ArgumentNullException.ThrowIfNull(server);
        ...
        {
            var baseFilePath = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);

            ArgumentException.ThrowIfNullOrWhiteSpace(baseFilePath);

            return Path.Combine(baseFilePath, filePath);
        }
    }
}